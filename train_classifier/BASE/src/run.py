...
while not validInput:
    if train_classifier == "y":
        os.system("opencv_traincascade -data classifier/ -vec ./" + vec_file + " -bg bg.txt -numStages 12 -minHitRate 0.999 -maxFalseAlarmRate 0.5 -numNeg 3380 -numPos 100")
        validInput = True
